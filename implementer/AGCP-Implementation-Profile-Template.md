...
Controlled format companions:

- [AGCP Implementation Profile Specification](./AGCP-Implementation-Profile-Specification.md), format version `1.1.0`
- [AGCP Implementation Profile Schema](./AGCP-Implementation-Profile-Schema.json), JSON Schema Draft 2020-12

Repository supersession notice: this file supersedes the misleading repository filename `AGCP-Implementation-Decision-Record-Template.md`. A completed artifact produced from this template is an Implementation Profile; material architecture or security decisions referenced by the profile remain separate ADRs or IDRs.
