...
|---|---|---|
| Repository release target | `v2.0.4` | Current repository release identity. |
...
| Controlling published baseline | `v2.0.4` | The release governs the artifacts contained in this repository snapshot. |
...
| Current repository specification version | `2.0.4` | Version applied to current specifications, interfaces, catalogs, and release metadata. |
...
5. The release tag, release archive, checksum publication, and repository content SHALL identify the same `v2.0.4` artifact set.
