...
notes=(ROOT/CURRENT_RELEASE_NOTES).read_text(); check('release_notes_metadata',all(x in notes[:800] for x in ['Public Review Controlled Baseline','CURRENT','2026-08-05']))
