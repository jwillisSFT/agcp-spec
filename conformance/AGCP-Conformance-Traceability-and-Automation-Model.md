...
The controlled relationships for the current AGCP v2.0.0 model are:
...
At the controlled AGCP v2.0.0 baseline, the mapping set contains 122 Formal Test Cases, 16 Harness Checks, and 28 Harness Test Vectors. These counts are release metadata, not permanent relationship constraints.
